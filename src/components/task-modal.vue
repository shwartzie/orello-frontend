<template>
    ...
    >
        <section class="task-modal-info" @click.stop="">
            <img
                v-if="currTask.attachments"
                src="currTask.attachments[0]"
                alt=""
            />
            ...
            <section class="flex space-between">
                <section class="left-side-modal-container">
                    <div class="flex labels">
                        <h5>Labels</h5>
                        <div
                            v-for="label in currGroup.labels"
                            v-if="currGroup.labels"
                        >
                            <a class="label">label</a>
                        </div>
                        <a @click="labelPicker = true" v-if="!labelPicker">+</a>
<<<<<<< HEAD
                        <label-picker v-if="labelPicker" :board="board" @addedLabel="addLabel" @closePicker="closeLabelPicker"/>
=======
                        <label-picker
                            v-if="labelPicker"
                            :board="board"
